...
public class AmpereStringListSettingScreen extends Screen {
    ...
    private AmpereChatField entryField;
    ...
    public AmpereStringListSettingScreen(Screen parent, PackModule module, PackModuleOption option) {
    ...
    private void ensureFields() {
        if (entryField == null) {
            entryField = new AmpereChatField(minecraft, font, 0, 0, 1, FIELD_H, false);
            entryField.setMaxLength(512);
            entryField.setChangedListener(value -> suggestionIndex = 0);
        }
        if (searchField == null) {
            searchField = new AmpereChatField(minecraft, font, 0, 0, 1, FIELD_H, false);
