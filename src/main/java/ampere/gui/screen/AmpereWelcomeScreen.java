...
public class AmpereWelcomeScreen extends Screen {
    ...
    private static final Identifier HUD_LOGO = Identifier.fromNamespaceAndPath("ampere", "textures/gui/hud/Ampere_welcome.png");
    ...
    private static final String[][] SECTIONS = {
        {"Donate",
            "If Ampere Client has helped you or made Minecraft more fun, a donation is a kind way to support the time behind it."},
        {"Choose Method",
    ...
    private final Btn crypto = new Btn("crypto", "Crypto", DONATE_SUPPORT_ICON, SUPPORT_ICON_WIDTH, SUPPORT_ICON_HEIGHT, () -> AmpereLinks.open(AmpereLinks.CRYPTO_DONATE));
    private final Btn donate = new Btn("donate", "Card/PayPal", DONATE_SUPPORT_ICON, SUPPORT_ICON_WIDTH, SUPPORT_ICON_HEIGHT, () -> AmpereLinks.open(AmpereLinks.KOFI));
    ...
    public boolean mouseClicked(MouseButtonEvent event, boolean doubleClick) {
        ...
        float mx = (float) AmpereUiScale.toVirtual(event.x());
        float my = (float) AmpereUiScale.toVirtual(event.y());
        layout();
