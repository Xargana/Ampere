...
public class AmpereProxyConfigScreen extends Screen {
    ...
    public AmpereProxyConfigScreen(Screen parent) {
    ...
    private void rebuildRows() {
        ...
        AmpereProxyManager mgr = AmpereProxyManager.get();
        ...
        y += ROW_HEIGHT;
        addToggleRow("Sort by latency", mgr.isSortByLatency(), "Cleanup sorts alive proxies from fastest to slowest.", value -> mgr.setSortByLatency(value), panelX, panelW, y);
        y += ROW_HEIGHT;
