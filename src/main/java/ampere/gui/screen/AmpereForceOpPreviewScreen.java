...
public class AmpereForceOpPreviewScreen extends Screen {
    ...
    public AmpereForceOpPreviewScreen(Screen parent, String[] passwords) {
    ...
    public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float delta) {
        ...
        try {
            ...
            ampere.gui.vanillaui.UiScissorStack.global().push(graphics,
                ampere.gui.vanillaui.UiBounds.of(innerX, innerY, Math.max(0, innerW), Math.max(0, innerH)));
            try {
