...
import ampere.addons.AddonManager;
import ampere.addons.AddonManager.AddonLoadStatus;
import ampere.addons.AddonManager.AddonReport;
...
public final class AmpereAddonsScreen extends Screen {
    ...
    public AmpereAddonsScreen(Screen parent) {
    ...
    private void renderRows(GuiGraphicsExtractor graphics, int mouseX, int mouseY) {
        ...
        if (reports.isEmpty()) {
            drawText(graphics, AddonManager.reports().isEmpty() ? "No Ampere addons discovered." : "No addons match the search.",
    ...
    public boolean mouseDragged(MouseButtonEvent event, double dx, double dy) {
        ...
        return super.mouseDragged(virtual, AmpereUiScale.toVirtual(dx), AmpereUiScale.toVirtual(dy));
    }
    ...
    private void copyId() {
        ...
        AmpereNotifications.copied("Addon ID copied.");
    }
    ...
    private void copyReport() {
        ...
        AmpereNotifications.copied("Addon report copied.");
    }
    ...
    private void toggleRestartDisabled() {
        ...
        AmpereNotifications.show(next ? "Addon disables after restart." : "Addon enables after restart.", next ? WARN : SUCCESS);
        rebuildButtons();
    }
