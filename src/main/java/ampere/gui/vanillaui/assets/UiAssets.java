package ampere.gui.vanillaui.assets;

import net.minecraft.resources.Identifier;

public final class UiAssets {
    public static final Identifier FONT_BODY = Identifier.fromNamespaceAndPath("ampere", "pack_ui_body");
    public static final Identifier FONT_LABEL = Identifier.fromNamespaceAndPath("ampere", "pack_ui_label");
    public static final Identifier FONT_TITLE = Identifier.fromNamespaceAndPath("ampere", "pack_ui_title");
    ...
    private static Identifier icon(String name) {
        return Identifier.fromNamespaceAndPath("ampere", "textures/gui/vanillaui/icons/" + name + ".png");
    }
}
