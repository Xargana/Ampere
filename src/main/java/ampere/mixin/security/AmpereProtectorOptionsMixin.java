...
@Mixin(Options.class)
public class AmpereProtectorOptionsMixin {
    ...
    private KeyMapping Ampere$keyMapping(String name, int key, KeyMapping.Category category, Operation<KeyMapping> original) {
        AmpereProtectorTracker.addVanillaKeybind(name);
    ...
    private KeyMapping Ampere$keyMapping(String name, InputConstants.Type type, int key, KeyMapping.Category category, Operation<KeyMapping> original) {
        AmpereProtectorTracker.addVanillaKeybind(name);
    ...
    private KeyMapping Ampere$keyMapping(String name, InputConstants.Type type, int key, KeyMapping.Category category, int order, Operation<KeyMapping> original) {
        AmpereProtectorTracker.addVanillaKeybind(name);
    ...
    private ToggleKeyMapping Ampere$toggleKeyMapping(String name, int key, KeyMapping.Category category, BooleanSupplier needsToggle,
    ...
    private ToggleKeyMapping Ampere$toggleKeyMapping(String name, InputConstants.Type type, int key, KeyMapping.Category category,
