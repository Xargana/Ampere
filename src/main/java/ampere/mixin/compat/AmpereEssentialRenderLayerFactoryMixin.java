...
public abstract class AmpereEssentialRenderLayerFactoryMixin {
    @WrapMethod(method = "createRenderLayer")
    private RenderType Ampere$createRenderLayerDirectly(String name, RenderSetup setup, Operation<RenderType> original) {
