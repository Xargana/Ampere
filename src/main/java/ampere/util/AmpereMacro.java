...
public class AmpereMacro {
    ...
    public AmpereMacro(String name) {
        this.name = name;
    }

    public AmpereMacro deepCopy() {
        return new AmpereMacro().fromTag(this.toTag());
    }

    public AmpereMacro deepCopy(String newName) {
        AmpereMacro copy = deepCopy();
    ...
    public AmpereMacro sanitizeForSharing() {
        if (actions != null) {
    ...
    public AmpereMacro fromTag(CompoundTag tag) {
                    ...
                    if (actionTag.contains("type")) {
                        try {
                            ...
                            switch (type) {
                                ...
                                case INTERACT_ENTITY: action = new ampere.util.macro.InteractEntityAction(); break;
                                ...
                                case RACE: action = new ampere.util.macro.RaceAction(); break;
                                case REPORT: action = new ampere.util.macro.ReportAction(); break;
                                case VCLIP: action = new ampere.util.macro.VClipAction(); break;
                                case HCLIP: action = new ampere.util.macro.HClipAction(); break;
    ...
    private static MacroAction recoverUnknownAction(CompoundTag actionTag) {
        ...
        java.util.function.Supplier<MacroAction> factory = ampere.api.macro.MacroActionRegistry.factory(typeName);
        if (factory != null) {
            ...
            try {
                ...
                AmpereClientAddon.LOG.warn("[MacroActions] Addon action '{}' failed to deserialize; keeping as placeholder", typeName, t);
            }
        }
    ...
    public boolean equals(Object o) {
        ...
        AmpereMacro that = (AmpereMacro) o;
