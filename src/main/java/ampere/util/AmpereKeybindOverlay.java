...
import ampere.gui.vanillaui.direct.DirectUiNode;
import ampere.gui.vanillaui.direct.DirectUiButton;
import ampere.gui.vanillaui.direct.DirectFormRow;
...
import ampere.gui.vanillaui.direct.DirectCompactKeybindButton;
...
public class AmpereKeybindOverlay extends AmpereOverlayBase {
    ...
    public AmpereKeybindOverlay() {
        super("Ampere-keybinds", MIN_PANEL_WIDTH, 142);
        this.panelX = 160;
        this.panelY = 46;
        entries.add(new KeybindEntry("Module Menu", "Opens the Ampere module click GUI", () -> getConfig().keybindModuleMenu, v -> getConfig().keybindModuleMenu = v));
    ...
    private AmpereConfig getConfig() {
        return AmpereConfig.getGlobal();
    }
    ...
    public static String getKeyName(int keyCode) {
        return AmpereBindUtil.getBindName(keyCode);
    }
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        ...
        if (capturingIndex >= 0 && AmpereBindUtil.isAllowedMouseButton(button)) {
            captureBind(AmpereBindUtil.encodeMouseButton(button));
            return true;
        }
        ...
        private ToggleRowNode(String label, String tooltip,
            ...
            super(
                ...
                new DirectUiButton("OFF", DirectUiButton.Variant.SECONDARY, null)
                    ...
                    .setConnectedEdges(ampere.gui.vanillaui.components.ConnectedButton.FULL)
                    .setTextYOffset(0)
            );
            this.getter = getter;
            this.setter = setter;
    ...
    private final class PrefixRowNode extends DirectUiNode {
        ...
        public void render(DirectRenderContext context) {
            ...
            String value = AmpereCompatManager.effectiveCommandPrefix();
        ...
        public boolean mouseClicked(DirectRenderContext context, float mouseX, float mouseY, int button) {
            ...
            prefixDropdown = new Dropdown(controlBounds, AmpereCompatManager.COMMAND_PREFIX_CHOICES,
                AmpereCompatManager.effectiveCommandPrefix(), AmpereKeybindOverlay.this::selectCommandPrefix);
            prefixDropdown.open();
            return true;
        }
    }
