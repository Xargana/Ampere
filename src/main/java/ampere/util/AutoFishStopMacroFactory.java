...
public final class AutoFishStopMacroFactory {
    ...
    public static AmpereMacro ensurePreset(Preset preset) {
    ...
    public static boolean isValidStopMacro(AmpereMacro macro) {
    ...
    public static boolean isGeneratedStopMacro(AmpereMacro macro) {
    ...
    private static AmpereMacro ensureMacro(String preferredName, MacroAction firstCondition) {
        AmpereMacroManager manager = AmpereMacroManager.get();
        AmpereMacro existing = manager.get(preferredName);
        if (existing != null) {
        ...
        AmpereMacro macro = new AmpereMacro(manager.createUniqueName(preferredName));
    ...
    private static boolean removeImmediateGeneratedAutoFishToggle(AmpereMacro macro) {
