...
public final class AmpereInventoryClickHelper {
    private AmpereInventoryClickHelper() {
    }
    ...
    private static boolean clickNow(Minecraft mc, int handlerSlotId, int button, ContainerInput input) {
        ...
        try {
            ...
            AmpereCursorClickHelper.recordAfterContainerClick(mc, handler, handlerSlotId, button, input, beforeCarried, beforeSlot);
            return true;
