...
public final class AmpereAutoTool {
    private AmpereAutoTool() {
    }
    ...
    public static boolean equipBestTool(Minecraft mc, BlockState state, boolean considerInventory, boolean ignoreDurability, boolean preferSilkTouch) {
        ...
        if (!AmpereInventoryHelper.swapInventorySlots(mc, best, selected)) return false;
        AmpereInventoryHelper.selectHotbarSlot(mc, selected);
        return true;
    }
}
