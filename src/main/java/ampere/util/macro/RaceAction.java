...
public class RaceAction implements MacroAction {
    ...
    private transient AmperePacketClick.Target legacyTarget = null;
    ...
    public void fromTag(CompoundTag tag) {
        ...
        MacroAction nested = tag.getCompound("triggerAction")
            .map(ampere.util.AmpereMacro::createActionFromTag)
            .orElse(null);
        ...
        if (tag.contains("triggerType")) {
            ...
            legacyTarget = tag.getCompound("target").map(AmperePacketClick.Target::fromTag).orElse(null);
        }
