...
public class XCarryAction implements MacroAction {
    ...
    private void executeWithContainerOpen(Minecraft mc) {
        ...
        AmpereContainerTarget containerTarget = AmpereSharedState.get().getLastContainerTarget();
    ...
    static void sendOpenTarget(Minecraft mc, AmpereContainerTarget target) {
