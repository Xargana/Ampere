...
public class OpenContainerAction implements MacroAction, WaitsForGui {
    ...
    public boolean tryExecute(Minecraft mc) {
        ...
        if (targetMode == TargetMode.ENTITY) {
            ...
            for (String ref : refs) {
                ...
                AmpereContainerTarget target = AmpereContainerTarget.forEntityRef(ref);
        ...
        AmpereContainerTarget target = targetMode == TargetMode.BLOCK
            ? AmpereContainerTarget.forBlock(blockPos)
            : AmpereSharedState.get().getLastContainerTarget();
    ...
    public void captureCurrentLookTarget(Minecraft mc) {
        ...
        if (mc.hitResult instanceof EntityHitResult entityHit && entityHit.getEntity() != null) {
            ...
            entityTarget = AmpereContainerTarget.toSpecificEntityRef(entityHit.getEntity());
    ...
    private static String entityTargetLabel(String targetRef) {
        ...
        return AmpereRegistryLabels.entity(targetRef);
    }
