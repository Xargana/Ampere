...
public final class AmpereContainerTarget {
    ...
    private AmpereContainerTarget(Kind kind, BlockPos blockPos, String entityRef, InteractionHand hand, Vec3 hitPos, Direction blockSide, boolean insideBlock) {
        this.kind = kind;
    ...
    public static AmpereContainerTarget forBlock(BlockPos pos) {
        if (pos == null) return null;
        return new AmpereContainerTarget(Kind.BLOCK, pos, "", InteractionHand.MAIN_HAND, null, null, false);
    }

    public static AmpereContainerTarget forBlockHit(BlockHitResult hitResult, InteractionHand hand) {
        if (hitResult == null || hitResult.getBlockPos() == null) return null;
        return new AmpereContainerTarget(
            Kind.BLOCK,
    ...
    public static AmpereContainerTarget forEntity(Entity entity, InteractionHand hand) {
        if (entity == null) return null;
        return new AmpereContainerTarget(Kind.ENTITY_INTERACT, null, toSpecificEntityRef(entity), hand, null, null, false);
    }

    public static AmpereContainerTarget forEntityAt(Entity entity, InteractionHand hand, Vec3 hitPos) {
        if (entity == null) return null;
        return new AmpereContainerTarget(Kind.ENTITY_INTERACT_AT, null, toSpecificEntityRef(entity), hand, hitPos, null, false);
    }

    public static AmpereContainerTarget forEntityRef(String entityRef) {
        if (entityRef == null || entityRef.isBlank()) return null;
        return new AmpereContainerTarget(Kind.ENTITY_INTERACT, null, entityRef.trim(), InteractionHand.MAIN_HAND, null, null, false);
    }
