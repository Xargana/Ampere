...
public final class AmpereRegistryLabels {
    ...
    public static String identifier(String rawId) {
        String key = normalizedKey(rawId);
        return IDENTIFIER_CACHE.computeIfAbsent(key, AmpereRegistryLabels::humanizeIdentifier);
    }
