...
public class AmpereCustomFilterOverlay extends AmpereOverlayBase {
    ...
    private final AmpereCustomFilterPresetOverlay presetManagerOverlay;
    ...
    public AmpereCustomFilterOverlay(Font textRenderer) {
        ...
        this.presetManagerOverlay = new AmpereCustomFilterPresetOverlay(textRenderer);
    ...
    public AmpereCustomFilterPresetOverlay getPresetManagerOverlay() {
        return presetManagerOverlay;
    }

    public AmperePacketSelectorOverlay getPacketSelectorOverlay() {
        return packetSelectorOverlay;
    }

    @Override
    public String getOverlayId() {
        return "Ampere-custom-filter";
    }
    ...
    public void render(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        try {
            ...
            y = drawAction(context, mouseX, mouseY, x, y, width, "Presets", () -> {
                ...
                AmpereOverlayManager.get().bringToFront(presetManagerOverlay);
    ...
    private int renderPacketSection(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta,
                                    ...
                                    AmpereModule module, CompactTextInput searchField, PacketListState listState) {
        int sectionStartY = y;
        ...
        if (filteredPackets.isEmpty()) {
            ...
            try {
                listLayout.forEachVisibleRow(filteredPackets.size(), (index, rowY) -> {
                    ...
                    String packetName = AmperePacketNamer.getFriendlyName(packetClass);
    ...
    private List<Class<? extends Packet<?>>> filterPackets(List<Class<? extends Packet<?>>> packets, String query) {
        ...
        for (Class<? extends Packet<?>> packetClass : packets) {
            String name = AmperePacketNamer.getFriendlyName(packetClass).toLowerCase(Locale.ROOT);
    ...
    private List<Class<? extends Packet<?>>> getCachedPackets(PacketListState state,
        ...
        sorted.sort(Comparator.comparing(AmperePacketNamer::getFriendlyName, String.CASE_INSENSITIVE_ORDER));
