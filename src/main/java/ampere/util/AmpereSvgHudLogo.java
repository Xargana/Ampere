...
public final class AmpereSvgHudLogo {
    private static final Minecraft MC = Minecraft.getInstance();
    private static final Identifier SVG_RESOURCE = Identifier.fromNamespaceAndPath("ampere", "textures/gui/hud/ampere.svg");
    private static final Identifier DYNAMIC_TEXTURE = Identifier.fromNamespaceAndPath("ampere", "dynamic/hud/ampere_svg");
    ...
    private static Entry entry(int width, int height) {
        ...
        try {
            ...
            MC.getTextureManager().register(id, new LinearDynamicTexture("Ampere SVG HUD Logo " + key, image));
