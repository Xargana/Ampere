...
public final class AmpereYarnMappings {
    private static final String RESOURCE_PATH = "/Ampere-inspector-mappings.tsv";
    ...
    private static void ensureLoaded() {
        if (loaded) return;
        synchronized (AmpereYarnMappings.class) {
            if (loaded) return;
            loadMappings();
            loaded = true;
        }
    ...
    private static void loadMappings() {
        try (InputStream stream = AmpereYarnMappings.class.getResourceAsStream(RESOURCE_PATH)) {
