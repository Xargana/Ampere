...
import ampere.api.event.AddonEvents;
import ampere.api.hud.HudElementProvider;
import ampere.api.hud.HudElements;
import ampere.api.macro.MacroActionEntry;
import ampere.api.macro.MacroActionRegistry;
import ampere.api.macro.MacroPresetRegistry;
...
public final class AmpereAddons {
    private AmpereAddons() {}
    ...
    public static List<AmpereAddon> list() { return AddonManager.loaded(); }
    ...
    public static final class Commands {
        ...
        public void register(Command command) {
            ampere.commands.AmpereCommands.registerAddonCommand(command, AddonManager.currentAddonId());
        }

        public AddonRegistrationResult registerDetailed(Command command) {
            return ampere.commands.AmpereCommands.registerAddonCommandDetailed(command, AddonManager.currentAddonId());
        }
    }
