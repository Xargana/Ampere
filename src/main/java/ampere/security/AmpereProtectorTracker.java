...
public final class AmpereProtectorTracker {
    ...
    private AmpereProtectorTracker() {
    }
    ...
    public static void bootstrap() {
        ...
        try {
            ...
            AmpereClientAddon.LOG.warn("[AmpereProtector] Failed to bootstrap mod ID set: {}", t.getMessage());
        }
    }
    ...
    private static TranslationDecision computeTranslationDecision(String key) {
        if (VANILLA_TRANSLATIONS.contains(key) || AmpereProtectorVanillaKeys.contains(key)) {
