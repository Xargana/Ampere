...
import ampere.mixin.accessor.AmpereItemStackRenderStateAccessor;
...
public final class GoldenLeverModule extends PackModule {
    ...
    public static void tintItemStackRenderState(ItemStackRenderState output) {
        ...
        AmpereItemStackRenderStateAccessor accessor = (AmpereItemStackRenderStateAccessor) output;
        ItemStackRenderState.LayerRenderState[] layers = accessor.Ampere$getLayers();
        int count = Math.min(accessor.Ampere$getActiveLayerCount(), layers.length);
