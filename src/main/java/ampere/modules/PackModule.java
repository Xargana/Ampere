...
public abstract class PackModule {
    ...
    public final void setEnabled(boolean enabled) {
        ...
        if (emitsToggleMessage() && !PackHideState.isSilenced()) {
            AmpereMessaging.sendPrefixed(message == null || message.isBlank()
    ...
    private AmpereConfig.ModuleState state() {
        AmpereConfig config = AmpereConfig.getGlobal();
        return config.modules.computeIfAbsent(id, ignored -> {
            AmpereConfig.ModuleState created = new AmpereConfig.ModuleState();
