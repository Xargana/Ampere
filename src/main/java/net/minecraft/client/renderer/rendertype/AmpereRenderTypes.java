...
public final class AmpereRenderTypes {
    private static final RenderPipeline STORAGE_ESP_FILL_PIPELINE = RenderPipeline.builder()
        .withLocation(Identifier.fromNamespaceAndPath("ampere", "pipeline/storage_esp_fill_see_through"))
    ...
    private static final RenderPipeline STORAGE_ESP_LINES_PIPELINE = RenderPipeline.builder()
        .withLocation(Identifier.fromNamespaceAndPath("ampere", "pipeline/storage_esp_lines_see_through"))
        .withUniform("DynamicTransforms", UniformType.UNIFORM_BUFFER)
        .withUniform("Projection", UniformType.UNIFORM_BUFFER)
    ...
    private static final RenderType STORAGE_ESP_FILL = RenderType.create(
        "Ampere_storage_esp_fill_see_through",
